...
$('<form action="#"><select><optgroup label="General"></optgroup></select><input type="submit" value="Submit"></form>').appendTo("#mainav");
$("<option />", {selected: "selected", value: "", text: "MENU"}).appendTo("#mainav select optgroup");
